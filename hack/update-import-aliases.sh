...
INCLUDE_PATH="(${ROOT_PATH}/hack/tools)"

# TODO: Add more directories, but need skip dir `./pkg/generated`, like:
#
...
do
   ...
   goimports -local "github.com/karmada-io/karmada-operator" -w "${var}"
done
