...
# karmada.io/karmada-operator-bundle:$VERSION and karmada.io/karmada-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= karmada.io/karmada-operator
...
IMG ?= rongzhang/karmada-operator:$(VERSION)
